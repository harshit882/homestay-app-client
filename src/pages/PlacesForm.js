...
const PlacesForm = () => {
    ...
    async function addPhotoByInputLink(e) {
      ...
      async function addNewPlace(e) {
        ...
        await axios.post("https://homestay-app-server.cyclic.app/places", placeData)
        
        
      }
  return (
    <div>
          <form className="w-full max-w-lg m-auto bg-gray-200 py-6 px-10 rounded-md" onSubmit={addNewPlace} >
            ...
            <button onClick={addNewPlace} className="w-full rounded-full bg-red-400 text-white h-full py-3 px-4 mb-3">
              Save
            </button>
          </form>
        </div>
